...
Drawings.GeomDrawWindow = function(sandbox) {
    ...
    SCWeb.core.Server.resolveScAddr(['nrel_boundary_point', ], function(keynodes) {
        self.keynodes.boundary = keynodes['nrel_boundary_point'];
        self.needUpdate = true;
        self.requestUpdate();
    });
    SCWeb.core.Server.resolveScAddr(['nrel_value', ], function(keynodes) {
    ...
    SCWeb.core.Server.resolveScAddr(['nrel_center_of_circle', ], function(keynodes) {
        self.keynodes.centerOfCircle = keynodes['nrel_center_of_circle'];
        self.needUpdate = true;
        self.requestUpdate();
    });
    SCWeb.core.Server.resolveScAddr(['nrel_radius', ], function(keynodes) {
        self.keynodes.radiusOfCircle = keynodes['nrel_radius'];
        self.needUpdate = true;
        self.requestUpdate();
    });
    SCWeb.core.Server.resolveScAddr(['nrel_vertex', ], function(keynodes) {
        self.keynodes.vertex = keynodes['nrel_vertex'];
        self.needUpdate = true;
        self.requestUpdate();
    });
    SCWeb.core.Server.resolveScAddr(['nrel_sc_text_translation', ], function(keynodes) {
        self.keynodes.text_translation = keynodes['nrel_sc_text_translation'];
        self.needUpdate = true;
        self.requestUpdate();
    });
    SCWeb.core.Server.resolveScAddr(['nrel_area', ], function(keynodes) {
        self.keynodes.area = keynodes['nrel_area'];
        self.needUpdate = true;
        self.requestUpdate();
    });
    SCWeb.core.Server.resolveScAddr(['sc_definition', ], function(keynodes) {
        self.keynodes.definition = keynodes['sc_definition'];
        self.needUpdate = true;
        self.requestUpdate();
    });
    SCWeb.core.Server.resolveScAddr(['rrel_key_sc_element', ], function(keynodes) {
        self.keynodes.key_sc_element = keynodes['rrel_key_sc_element'];
        self.needUpdate = true;
        self.requestUpdate();
    });
    SCWeb.core.Server.resolveScAddr(['rrel_example', ], function(keynodes) {
        self.keynodes.example = keynodes['rrel_example'];
        self.needUpdate = true;
        self.requestUpdate();
    });
    SCWeb.core.Server.resolveScAddr(['nrel_perimeter', ], function(keynodes) {
