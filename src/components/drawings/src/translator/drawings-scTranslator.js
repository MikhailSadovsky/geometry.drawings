            ...
            if (triangle.className == 'Triangle') {
                ...
                if (triangle.segment1.length != undefined && triangle.segment2.length != undefined && triangle.segment3.length != undefined) {
                    ...
                    if (!this.isCorrectTriangle(side1, side2, side3)) {
                        $('#textArea').val($('#textArea').val() + 'Incorrect values of triangle ' + triangleName + ' sides. Please, correct it.');
                        continue;
                    }
                    perim += parseInt(triangle.segment1.length) + parseInt(triangle.segment2.length) + parseInt(triangle.segment3.length);
                    $('#textArea').val($('#textArea').val() + "Perimeter of triangle " + triangleName + " is : " + perim.toFixed(1) + "\n");
                }
            }
        }
    },
        ...
        for (var i = 0; i < model.shapes.length; i++) {
            ...
            if (triangle.className == 'Triangle') {
                ...
                if (triangle.segment1.length != undefined && triangle.segment2.length != undefined && triangle.segment3.length != undefined) {
                    ...
                    $('#textArea').val($('#textArea').val() + "Area of triangle  " + triangleName + " is : " + square.toFixed(1) + "\n");
                }
            }
        }
    },
